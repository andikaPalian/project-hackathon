// Mock data for KIRA application
...
export const mockQuizQuestions: QuizQuestion[] = [
  {
    ...
    correctAnswer: 0,
    explanation:
      "Process memiliki address space sendiri yang terisolasi, sedangkan Thread berbagi memory space dengan process induknya. Hal ini membuat thread lebih ringan dan komunikasi antar thread lebih cepat.",
  },
  {
    id: "2",
    ...
    correctAnswer: 2,
    explanation:
      "Shortest Job First (SJF) dapat menyebabkan starvation karena process dengan burst time yang panjang mungkin tidak pernah mendapat giliran jika terus ada process dengan burst time pendek.",
  },
];
...
export const testimonials = [
  {
    id: "1",
    name: "Dika",
    jurusan: "Teknologi Informasi, UNIBOS",
    avatar: "D",
    content:
      "KIRA benar-benar membantu saya memahami konsep Sistem Operasi yang awalnya sangat membingungkan. Step-by-step explanation-nya luar biasa!",
  },
  {
    id: "2",
    name: "Kiky",
    ...
    avatar: "K",
    content:
      "Quiz generator-nya super helpful buat persiapan UAS. Pembahasannya detail dan mudah dipahami.",
  },
  {
    id: "3",
    name: "Imran",
    ...
    avatar: "I",
    content:
      "Fitur ringkasan UTS/UAS sangat membantu menghemat waktu belajar. Recommended banget untuk mahasiswa!",
  },
  {
    id: "4",
    name: "Rafli",
    jurusan: "Teknologi Informasi, UNIBOS",
    avatar: "R",
    content: "AI Tutornya asik banget diajak diskusi materi yang berat jadi kerasa lebih ringan.",
  },
];

export const faqItems = [
  {
    question: "Apa itu KIRA?",
    answer:
      "KIRA adalah AI companion yang membantu mahasiswa memahami materi kuliah secara step-by-step, menyesuaikan dengan gaya belajar masing-masing, dan membantu mengatur prioritas belajar.",
  },
  {
    question: "Bagaimana cara mulai menggunakan KIRA?",
    answer:
      "Cukup daftar akun, upload materi kuliah (PDF/PPT), dan KIRA akan otomatis memecah materi menjadi topik-topik yang mudah dipahami. Kamu bisa mulai belajar interaktif dari sana.",
  },
  {
    question: "Format file apa saja yang didukung?",
    answer:
      "Saat ini KIRA mendukung file PDF dan PowerPoint (PPT/PPTX). Kami akan terus menambahkan dukungan untuk format lainnya.",
  },
  {
    question: "Apakah KIRA memberikan jawaban langsung?",
    answer:
      "KIRA dirancang untuk membimbing kamu memahami konsep, bukan memberikan jawaban langsung. AI akan menjelaskan step-by-step dan mengajukan pertanyaan pemandu agar kamu benar-benar paham.",
  },
  {
    question: "Apakah data dan materi saya aman?",
    answer:
      "Ya, keamanan data adalah prioritas kami. Semua materi yang kamu upload dienkripsi dan hanya bisa diakses oleh kamu sendiri.",
  },
];
...
export const mockConversation: ChatMessage[] = [
  {
    ...
    role: "assistant",
    content:
      "Halo! Saya KIRA, AI companion belajarmu. Hari ini kita akan mempelajari tentang **CPU Scheduling**. Siap untuk mulai? 🎓",
    timestamp: "10:00",
  },
  {
    id: "2",
...
export const learningModes = [
  {
    id: "kayak-sma",
    label: "Kayak Anak SMA",
    description: "Penjelasan sederhana seperti untuk pemula",
  },
